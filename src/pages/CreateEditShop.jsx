...
function CreateEditShop() {
    ...
    const [contactNumber, setContactNumber] = useState(myShopData?.contactNumber || "")

     const [address,setFullAddress]=useState(myShopData?.address || currentAddress)
     const [city,setCity]=useState(myShopData?.city || currentCity)
       ...
       const handleSubmit=async (e)=>{
        ...
        // ✅ STEP 3: Contact Number Validation (SAFE)
      if (!contactNumber) {
            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder='Enter Shop Address' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500' onChange={(e)=>setFullAddress(e.target.value)}
                        value={address}/> 
                    </div>
