...
<div className='flex justify-center items-center p-4 sm:p-6'>
    <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
        <div className='flex flex-col items-center text-center'>
            ...
            <p className='text-gray-600 mb-4 text-sm sm:text-base'>Share your delicious creations with our customers.</p>
...
<FaPen size={20}/>
             ...
             <div className='p-4 sm:p-6'>
              ...
              {myShopData.contactNumber && (
                      <p className='text-gray-600 font-medium'>
                       📞 Contact: {myShopData.contactNumber}
                   </p>
            )}
    ...
    <div className='flex flex-col items-center text-center'>
      ...
      >
        Add Food
           ...
           <button
  onClick={() => navigate("/chef/festival-specials")}
  className="px-4 py-2 bg-orange-500 text-white rounded"
>
  Manage Festival Specials
</button>
<button
  onClick={() => navigate("/chef/subscriptions")}
